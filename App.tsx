...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'calendar': return <Suspense fallback={<LazyFallback />}><CalendarView tasks={tasks} taskGroups={taskGroups} scheduleTemplates={scheduleTemplates} userId={user!.uid} expenses={expenses} /></Suspense>;
